...
func Routes(btService *bittorrent.BTService) *gin.Engine {
	...
	movie := r.Group("/movie")
	{
		...
		movie.GET("/:tmdbId/forcelinks", MoviePlaySelector("forcelinks", btService, false))
		movie.GET("/:tmdbId/play", MoviePlaySelector("play", btService, false))
		movie.GET("/:tmdbId/forceplay", MoviePlaySelector("forceplay", btService, false))
	...
	show := r.Group("/show")
	{
		...
		show.GET("/:showId/season/:season/episode/:episode/forceplay", ShowEpisodePlaySelector("forceplay", btService, false))
		show.GET("/:showId/season/:season/episode/:episode/links", ShowEpisodePlaySelector("links", btService, false))
		show.GET("/:showId/season/:season/episode/:episode/forcelinks", ShowEpisodePlaySelector("forcelinks", btService, false))
